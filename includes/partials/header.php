    ...
    <div class="top-announcement-bar bg-black text-white py-0 px-3 rounded-4 border border-dark mb-2 overflow-hidden">
        <div class="d-flex align-items-center justify-content-between w-100">
            ...
            <div class="d-none d-md-flex align-items-center gap-3">
                <a href="https://instagram.com" target="_blank" class="text-white text-opacity-75"
            ...
            <div class="announcement-ticker-wrapper overflow-hidden mx-auto position-relative d-flex align-items-center justify-content-center flex-grow-1"
                 style="min-height: 24px; max-width: 600px;">
                <ul class="list-unstyled mb-0 text-center fw-bold text-uppercase position-relative w-100 h-100 gsap-ticker-list"
                    style="font-size: clamp(0.55rem, 2.5vw, 0.6875rem); letter-spacing: 0.05em; line-height: 1.2;">
    ...
    <div class="container-fluid px-2 px-md-3">
        ...
        <nav class="navbar navbar-expand-lg py-0 px-3 border border-dark rounded-4 theme-glass-nav custom-header-grid bg-black navbar-dark"
            ...
            <div class="grid-zone-center text-center">
                <a class="navbar-brand m-0 d-inline-block align-middle" href="/" aria-label="Smash Apparel Home">
                    ...
                    <img src="<?= asset('images/logo-white.webp') ?>" alt="Smash Apparel Logo" width="100" height="32"
                         class="img-fluid object-fit-contain d-none d-md-inline-block" loading="eager"
                         fetchpriority="high">
                </a>
            </div>
            ...
            <div class="grid-zone-right d-flex align-items-center justify-content-end gap-1">
                ...
                <button class="btn btn-link p-2 text-white rounded-2 min-tap-target d-none d-lg-inline-flex"
                        id="bd-theme-toggle" type="button" aria-label="Toggle light and dark color theme">
                    <i class="bi bi-sun fs-6 d-block" aria-hidden="true"></i>
                </button>

                <!-- Search Button (Opens Offcanvas #searchDrawer) -->
                <button class="btn btn-link p-2 text-white rounded-2 min-tap-target" type="button"
                        data-bs-toggle="offcanvas" data-bs-target="#searchDrawer" aria-controls="searchDrawer"
                        aria-label="Search items">
                    <i class="bi bi-search fs-6 d-block" aria-hidden="true"></i>
                </button>

                <!-- Cart Button (Opens Offcanvas #cartDrawer) -->
                <button class="btn btn-link p-2 text-white position-relative rounded-2 d-inline-flex align-items-center justify-content-center min-tap-target"
                        type="button" data-bs-toggle="offcanvas" data-bs-target="#cartDrawer" aria-controls="cartDrawer"
                        aria-label="Shopping Cart with 1 item">
                    <i class="bi bi-bag fs-5 d-block" aria-hidden="true"></i>
                    <span class="position-absolute badge rounded-pill bg-danger text-white js-cart-count"
                          style="top: 2px; right: 0px; font-size: 0.6rem; padding: 0.25em 0.4em;">
                        1
                    </span>
                </button>
            </div>
                ...
                <div class="pt-3 pt-lg-0 w-100 d-lg-flex align-items-center justify-content-between">
                    ...
                    <ul class="navbar-nav mb-0 gap-lg-1 fw-bold text-uppercase small text-start flex-column flex-lg-row">
                        ...
                        <li class="nav-item dropdown position-static">
                            <a class="nav-link text-white px-2 py-1 rounded-2 d-inline-flex align-items-center gap-1 custom-dropdown-toggle"
                               ...
                               aria-expanded="false">
                                <span class="hover-theme"><span>Shop</span></span>
                                <i class="bi bi-chevron-down custom-caret ms-1" aria-hidden="true"></i>
                            </a>

                            <div class="dropdown-menu bg-black border border-dark rounded-4 p-0 mt-2 mt-lg-2 start-0 end-0 w-100 mega-menu-panel"
                                 aria-labelledby="megaMenuMens">
                                    ...
                                    <div class="row g-3 g-lg-4 text-start bg-black">
                                        <div class="col-12 col-lg-3">
                                            ...
                                            <ul class="list-unstyled d-flex flex-column gap-2 small mb-0">
                                                <li><a href="/collections/oversized-tees"
                                                       class="text-white text-decoration-none hover-theme">Oversized Gym
                                                        Tees</a></li>
                                                <li><a href="/collections/performance-tanks"
                                                       class="text-white text-decoration-none hover-theme">Performance
                                                        Tanks</a></li>
                                                <li><a href="/collections/hoodies"
                                                       class="text-white text-decoration-none hover-theme">Heavyweight
                                                        Hoodies</a></li>
                                                <li><a href="/collections/shorts"
                                                       class="text-white text-decoration-none hover-theme">Pro-Performance
                                                        Shorts</a></li>
                                            </ul>
                                        </div>
                                        ...
                                        <div class="col-12 col-lg-3">
                                            ...
                                            <ul class="list-unstyled d-flex flex-column gap-2 small mb-0">
                                                <li><a href="/collections/compression"
                                                       class="text-white text-decoration-none hover-theme">Seamless
                                                        Compression</a></li>
                                                <li><a href="/collections/recovery"
                                                       class="text-white text-decoration-none hover-theme">Thermal
                                                        Recovery Sweats</a></li>
                                                <li><a href="/collections/outerwear"
                                                       class="text-white text-decoration-none hover-theme">Waterproof
                                                        Outerwear</a></li>
                                                <li><a href="/collections/base-layers"
                                                       class="text-white text-decoration-none hover-theme">Base
                                                        Layers</a></li>
                                            </ul>
                                        </div>
                                        ...
                                        <div class="col-12 col-lg-3 d-none d-lg-block">
                                            <a href="/collections/mens-new" class="text-decoration-none d-block h-100">
                                                <div class="card border border-dark bg-dark text-white overflow-hidden rounded-3 h-100 p-3 d-flex flex-column justify-content-between position-relative"
                                                     style="min-height: 180px;">
                                                    <img src="/smashapparel/assets/images/slide_6.png"
                                                         alt="Pro-Series Activewear Drop"
                                                    ...
                                                    <div class="position-relative z-2">
                                                        <h6 class="fw-bolder text-uppercase mb-1 text-white">Pro-Series
                                                            Activewear</h6>
                                                        <span class="small text-white d-inline-flex align-items-center gap-1">Explore Drop <i
                                        ...
                                        <div class="col-12 col-lg-3 d-none d-lg-block">
                                            <a href="/collections/mens-trending"
                                               class="text-decoration-none d-block h-100">
                                                <div class="card border border-dark bg-dark text-white overflow-hidden rounded-3 h-100 p-3 d-flex flex-column justify-content-between position-relative"
                                                     style="min-height: 180px;">
                                                    <img src="/smashapparel/assets/images/slide_8.webp"
                                                         alt="Core Essentials Trending"
                                                         class="position-absolute top-0 start-0 w-100 h-100 object-fit-cover z-0"
                                                         loading="lazy">
                                                    <div class="position-absolute top-0 start-0 w-100 h-100 bg-dark opacity-50 z-1"></div>
                                                    ...
                                                    <div class="position-relative z-2">
                                                        <h6 class="fw-bolder text-uppercase mb-1 text-white">Core
                                                            Essentials</h6>
                                                        <span class="small text-white d-inline-flex align-items-center gap-1">Shop Trending <i
                                                                    class="bi bi-arrow-right"></i></span>
                                                    </div>
                                                </div>
                                            </a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-white px-2 py-1 rounded-2 hover-theme"
                    ...
                    <div class="d-lg-none mt-4 pt-3 border-top border-dark w-100 d-flex flex-column gap-2 text-start">
                        <div class="d-flex align-items-center justify-content-between p-2 rounded-3 bg-dark text-white">
                            ...
                            <button class="btn btn-link p-1 text-white rounded-2" id="bd-theme-toggle-mobile"
                        ...
                        <a href="/account"
                           class="btn btn-dark text-white border border-dark w-100 rounded-pill fw-bold text-uppercase py-2 mb-2">
                            Account (Alex)
                        </a>
                    </div>
            ...
            <div class="row align-items-center justify-content-between gy-3">
                <div class="col-12 col-lg-10 col-xl-9 mx-auto">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <span id="searchDrawerLabel"
                              class="text-uppercase tracking-widest fw-bold text-body fs-8 d-flex align-items-center gap-2">
                    ...
                    <div class="d-flex align-items-center gap-2 mt-3 overflow-x-auto no-scrollbar">
                        ...
                        <a href="{{ routes.search_url }}?type=product&q=hoodie"
                           class="badge bg-body-tertiary text-body border border-body-subtle text-decoration-none rounded-pill fw-bold fs-8 tracking-wider hover-scale">HOODIES</a>
                        <a href="{{ routes.search_url }}?type=product&q=cargo"
                           class="badge bg-body-tertiary text-body border border-body-subtle text-decoration-none rounded-pill fw-bold fs-8 tracking-wider hover-scale">CARGOS</a>
                        <a href="{{ routes.search_url }}?type=product&q=oversized"
                           class="badge bg-body-tertiary text-body border border-body-subtle text-decoration-none rounded-pill fw-bold fs-8 tracking-wider hover-scale">OVERSIZED</a>
                        <a href="{{ routes.search_url }}?type=product&q=fleece"
                           class="badge bg-body-tertiary text-body border border-body-subtle text-decoration-none rounded-pill fw-bold fs-8 tracking-wider hover-scale">FLEECE</a>
                    </div>
...
<div class="offcanvas offcanvas-end bg-transparent border-0 p-0 px-md-4 js-cart-drawer-container" tabindex="-1"
     id="cartDrawer" style="width: 700px; max-width: 100vw;">
    <div class="bg-body-tertiary border-md rounded-0 rounded-md-4 rounded-4 d-flex flex-column overflow-hidden custom-drawer-content h-100 h-md-auto"
        ...
        <div class="offcanvas-header d-flex flex-column align-items-stretch p-3 p-md-4 pb-2 border-0">
            <div class="d-flex justify-content-between align-items-center w-100 mb-1">
                ...
                <button type="button"
                        class="btn bg-black text-white rounded-4 p-2 d-flex align-items-center justify-content-center border-0 btn-close-custom js-cart-close"
        ...
        <div class="offcanvas-body px-3 px-md-4 py-0 d-flex flex-column justify-content-between rounded-4 overflow-x-hidden overflow-y-auto">
            ...
            <div class="cart-drawer-items d-flex flex-column gap-3 py-2 js-cart-populated">
                <div class="cart-item-row d-flex align-items-stretch gap-2 gap-md-3">
                    ...
                    <div class="card bg-body border rounded-4 p-2 p-md-3 flex-grow-1 min-w-0 js-cart-card">
                        <div class="d-flex align-items-center gap-3 gap-md-4 h-100">
                            ...
                            <div class="flex-shrink-0 bg-body-secondary border rounded-3 overflow-hidden d-flex align-items-center justify-content-center js-item-img">
                                <img src="<?= asset('/images/2026 Ladies SA Performance Top Qtr Sleeve - White 1.webp') ?>"
                                     alt="Pro-Series Oversized Tee"
                                     class="img-fluid object-fit-cover object-fit-top p-1" loading="lazy"
                            ...
                            <div class="flex-grow-1 min-w-0 js-item-details">
                                <div class="d-flex align-items-center gap-2 mb-1">
                                    ...
                                    <span class="text-uppercase text-secondary fw-bold d-none d-sm-inline-block"
                                          style="font-size: 0.65rem;">In Stock</span>
                                </div>
                                <h5 class="fw-bolder text-uppercase mb-1 text-body text-truncate fs-6 fs-md-5">
                                    Pro-Series Oversized Tee</h5>
                                ...
                                <div class="d-flex align-items-baseline gap-2 js-item-price">
                                    <span class="fw-bolder fs-4 fs-md-3 text-body">$<span class="js-item-price-base"
                                                                                          data-price="65.00">65.00</span></span>
                    ...
                    <div class="flex-shrink-0 bg-black text-white rounded-4 d-flex flex-column align-items-center justify-content-between p-2 p-md-3 qty-pill-container js-qty-container"
                         style="width: 48px;">
                        <button class="btn btn-link text-white p-0 border-0 fw-bold lh-1 text-decoration-none js-qty-plus"
                                type="button" aria-label="Increase Quantity">
                            <i class="bi bi-plus-lg fs-6"></i>
                        </button>
                        <span class="fw-bolder fs-6 fs-md-5 text-white js-qty-count">1</span>
                        <button class="btn btn-link text-white p-0 border-0 fw-bold lh-1 text-decoration-none js-qty-minus"
            ...
            <div class="cart-drawer-empty d-none flex-column align-items-center justify-content-center text-center py-5 my-auto js-cart-empty">
                ...
                <a href="/collections/all"
                   class="btn btn-dark rounded-pill px-5 py-3 fw-bold text-uppercase fs-6 js-empty-btn">Continue
                    Shopping</a>
            </div>
        </div>
        ...
        <div class="offcanvas-footer p-3 p-md-4 border-top border-0 js-cart-footer bg-body mt-auto">
            ...
            <a href="/checkout"
               class="btn btn-brand w-100 rounded-pill py-3 fs-6 fw-bolder tracking-wider d-flex align-items-center justify-content-center gap-2 btn-checkout js-checkout-btn">
